...
class Node(object):
    ...
    def get(self, identifier):
        ...
        """
        return self._presenter.interpret(identifier,
    ...
    def set(self, identifier, value):
        ...
        """
        self._set_raw_list(identifier,
                           self._presenter.serialise(identifier, value))
...
class _Unexpanded_root_tree_node(_Root_tree_node):
    ...
    def _expand(self):
        sgf_grammar.make_tree(self._coarse_tree, self, Tree_node,
